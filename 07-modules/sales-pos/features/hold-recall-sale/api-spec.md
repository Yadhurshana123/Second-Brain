---
title: "Hold Recall Sale API Specification"
...
# Hold Recall Sale API Specification

## API Ownership
The `hold-recall-sale` API belongs to the `sales-pos` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/sales-pos/hold-recall-sale` | `sales-pos.hold-recall-sale.read` |
| Detail | GET | `/api/v1/sales-pos/hold-recall-sale/{id}` | `sales-pos.hold-recall-sale.read` |
| Create | POST | `/api/v1/sales-pos/hold-recall-sale` | `sales-pos.hold-recall-sale.create` |
| Update | PUT | `/api/v1/sales-pos/hold-recall-sale/{id}` | `sales-pos.hold-recall-sale.update` |
| State action | POST | `/api/v1/sales-pos/hold-recall-sale/{id}/actions/{action}` | Action-specific permission |
...
## Request Example
```http
POST /api/v1/sales-pos/hold-recall-sale
...
{
  "featureKey": "sales-pos.hold-recall-sale",
...
- Access consideration 1: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `sales-pos.hold-recall-sale.read` may show data, while command permissions must be separately configured per role.
