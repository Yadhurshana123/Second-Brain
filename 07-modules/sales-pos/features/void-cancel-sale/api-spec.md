---
title: "Void Cancel Sale API Specification"
...
# Void Cancel Sale API Specification

## API Ownership
The `void-cancel-sale` API belongs to the `sales-pos` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/sales-pos/void-cancel-sale` | `sales-pos.void-cancel-sale.read` |
| Detail | GET | `/api/v1/sales-pos/void-cancel-sale/{id}` | `sales-pos.void-cancel-sale.read` |
| Create | POST | `/api/v1/sales-pos/void-cancel-sale` | `sales-pos.void-cancel-sale.create` |
| Update | PUT | `/api/v1/sales-pos/void-cancel-sale/{id}` | `sales-pos.void-cancel-sale.update` |
| State action | POST | `/api/v1/sales-pos/void-cancel-sale/{id}/actions/{action}` | Action-specific permission |
...
## Request Example
```http
POST /api/v1/sales-pos/void-cancel-sale
...
{
  "featureKey": "sales-pos.void-cancel-sale",
...
- Access consideration 1: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `sales-pos.void-cancel-sale.read` may show data, while command permissions must be separately configured per role.
