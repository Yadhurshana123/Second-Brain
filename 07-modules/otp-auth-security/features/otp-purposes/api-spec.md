---
title: "Otp Purposes API Specification"
...
# Otp Purposes API Specification

## API Ownership
The `otp-purposes` API belongs to the `otp-auth-security` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/otp-auth-security/otp-purposes` | `otp-auth-security.otp-purposes.read` |
| Detail | GET | `/api/v1/otp-auth-security/otp-purposes/{id}` | `otp-auth-security.otp-purposes.read` |
| Create | POST | `/api/v1/otp-auth-security/otp-purposes` | `otp-auth-security.otp-purposes.create` |
| Update | PUT | `/api/v1/otp-auth-security/otp-purposes/{id}` | `otp-auth-security.otp-purposes.update` |
| State action | POST | `/api/v1/otp-auth-security/otp-purposes/{id}/actions/{action}` | Action-specific permission |
...
## Request Example
```http
POST /api/v1/otp-auth-security/otp-purposes
...
{
  "featureKey": "otp-auth-security.otp-purposes",
...
- Access consideration 1: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `otp-auth-security.otp-purposes.read` may show data, while command permissions must be separately configured per role.
