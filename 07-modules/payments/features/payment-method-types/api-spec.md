---
title: "Payment Method Types API Specification"
...
# Payment Method Types API Specification

## API Ownership
The `payment-method-types` API belongs to the `payments` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/payments/payment-method-types` | `payments.payment-method-types.read` |
| Detail | GET | `/api/v1/payments/payment-method-types/{id}` | `payments.payment-method-types.read` |
| Create | POST | `/api/v1/payments/payment-method-types` | `payments.payment-method-types.create` |
| Update | PUT | `/api/v1/payments/payment-method-types/{id}` | `payments.payment-method-types.update` |
| State action | POST | `/api/v1/payments/payment-method-types/{id}/actions/{action}` | Action-specific permission |
...
## Request Example
```http
POST /api/v1/payments/payment-method-types
...
{
  "featureKey": "payments.payment-method-types",
...
- Access consideration 1: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `payments.payment-method-types.read` may show data, while command permissions must be separately configured per role.
