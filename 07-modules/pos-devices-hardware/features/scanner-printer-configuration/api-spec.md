---
title: "Scanner Printer Configuration API Specification"
...
# Scanner Printer Configuration API Specification

## API Ownership
The `scanner-printer-configuration` API belongs to the `pos-devices-hardware` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/pos-devices-hardware/scanner-printer-configuration` | `pos-devices-hardware.scanner-printer-configuration.read` |
| Detail | GET | `/api/v1/pos-devices-hardware/scanner-printer-configuration/{id}` | `pos-devices-hardware.scanner-printer-configuration.read` |
| Create | POST | `/api/v1/pos-devices-hardware/scanner-printer-configuration` | `pos-devices-hardware.scanner-printer-configuration.create` |
| Update | PUT | `/api/v1/pos-devices-hardware/scanner-printer-configuration/{id}` | `pos-devices-hardware.scanner-printer-configuration.update` |
| State action | POST | `/api/v1/pos-devices-hardware/scanner-printer-configuration/{id}/actions/{action}` | Action-specific permission |
...
## Request Example
```http
POST /api/v1/pos-devices-hardware/scanner-printer-configuration
...
{
  "featureKey": "pos-devices-hardware.scanner-printer-configuration",
...
- Access consideration 1: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `pos-devices-hardware.scanner-printer-configuration.read` may show data, while command permissions must be separately configured per role.
