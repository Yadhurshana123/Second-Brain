---
title: "Terminal Outlet Assignment API Specification"
...
# Terminal Outlet Assignment API Specification

## API Ownership
The `terminal-outlet-assignment` API belongs to the `pos-devices-hardware` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/pos-devices-hardware/terminal-outlet-assignment` | `pos-devices-hardware.terminal-outlet-assignment.read` |
| Detail | GET | `/api/v1/pos-devices-hardware/terminal-outlet-assignment/{id}` | `pos-devices-hardware.terminal-outlet-assignment.read` |
| Create | POST | `/api/v1/pos-devices-hardware/terminal-outlet-assignment` | `pos-devices-hardware.terminal-outlet-assignment.create` |
| Update | PUT | `/api/v1/pos-devices-hardware/terminal-outlet-assignment/{id}` | `pos-devices-hardware.terminal-outlet-assignment.update` |
| State action | POST | `/api/v1/pos-devices-hardware/terminal-outlet-assignment/{id}/actions/{action}` | Action-specific permission |
...
- Access consideration 1: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `pos-devices-hardware.terminal-outlet-assignment.read` may show data, while command permissions must be separately configured per role.
