---
title: "Price Lists API Specification"
...
# Price Lists API Specification

## API Ownership
The `price-lists` API belongs to the `pricing` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/pricing/price-lists` | `pricing.price-lists.read` |
| Detail | GET | `/api/v1/pricing/price-lists/{id}` | `pricing.price-lists.read` |
| Create | POST | `/api/v1/pricing/price-lists` | `pricing.price-lists.create` |
| Update | PUT | `/api/v1/pricing/price-lists/{id}` | `pricing.price-lists.update` |
| State action | POST | `/api/v1/pricing/price-lists/{id}/actions/{action}` | Action-specific permission |
...
{
  "featureKey": "pricing.price-lists",
...
- Access consideration 1: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `pricing.price-lists.read` may show data, while command permissions must be separately configured per role.
