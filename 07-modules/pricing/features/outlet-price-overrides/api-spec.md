---
title: "Outlet Price Overrides API Specification"
...
# Outlet Price Overrides API Specification

## API Ownership
The `outlet-price-overrides` API belongs to the `pricing` module and must be implemented through ASP.NET Core controllers, application services, validators, repositories, and Unit of Work.
...
|---|---|---|---|
| Search/list | GET | `/api/v1/pricing/outlet-price-overrides` | `pricing.outlet-price-overrides.read` |
| Detail | GET | `/api/v1/pricing/outlet-price-overrides/{id}` | `pricing.outlet-price-overrides.read` |
| Create | POST | `/api/v1/pricing/outlet-price-overrides` | `pricing.outlet-price-overrides.create` |
| Update | PUT | `/api/v1/pricing/outlet-price-overrides/{id}` | `pricing.outlet-price-overrides.update` |
| State action | POST | `/api/v1/pricing/outlet-price-overrides/{id}/actions/{action}` | Action-specific permission |
...
## Request Example
```http
POST /api/v1/pricing/outlet-price-overrides
...
{
  "featureKey": "pricing.outlet-price-overrides",
...
- Access consideration 1: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 2: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 3: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 4: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 5: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 6: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 7: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 8: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 9: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 10: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
- Access consideration 11: Permission `pricing.outlet-price-overrides.read` may show data, while command permissions must be separately configured per role.
