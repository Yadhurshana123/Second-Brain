...
document_id: SEC-README
last_updated: 2026-05-11
tags: [security, index, compliance]
---

# Security and Compliance Index

## Purpose
This folder defines cross-cutting security controls for the Unified Commerce SaaS platform. It protects tenant data, POS transactions, e-commerce orders, payments, offline sync, audit trails, and role-based operational access.
...
| `roles` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `permissions` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `role_permissions` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `tenant_user_roles` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `outlet_user_roles` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `platform_features` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `tenant_feature_entitlements` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
| `role_feature_assignments` | Must be tenant-aware, access-controlled, audited, or protected according to this document. |
...
|---|---|
| `security.policy.read` | Must be checked by backend services before the corresponding operation is executed. |
| `audit.log.read` | Must be checked by backend services before the corresponding operation is executed. |
| `rbac.permission.manage` | Must be checked by backend services before the corresponding operation is executed. |
| `tenant.feature.assign` | Must be checked by backend services before the corresponding operation is executed. |
...
|---|---|---|
| `GET` | `/api/v1/security/context` | Load effective tenant security context. |
| `GET` | `/api/v1/audit-logs` | Read controlled audit trail. |

```http
GET /api/v1/security/context HTTP/1.1
